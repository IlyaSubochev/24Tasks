        ...
        public static string PatternUnlock(int N, int[] hits)
        {
            ...
            {   
                ...
                //3
                    ...
                    sum = sum + 1.41421;
                else if (hits[i] == 3 && hits[i + 1] == 1)
                    sum = sum + 2;
                //4
                else if (hits[i] == 4 && (hits[i + 1] == 5 || hits[i + 1] == 3))
                    sum = sum + 1;
                else if (hits[i] == 4 && (hits[i + 1] == 6 || hits[i + 1] == 7))
                    sum = sum + 2;
                else if (hits[i] == 4 && hits[i + 1] == 2)
                    sum = sum + 1.41421;
                else if (hits[i] == 4 && hits[i + 1] == 9)
                    sum = sum + 2 * 1.41421;
                //5
                    ...
                    sum = sum + 1.41421;
                else if (hits[i] == 5 && hits[i + 1] == 8)
                    sum = sum + 2;
                //6
                else if (hits[i] == 6 && (hits[i + 1] == 1 || hits[i + 1] == 5))
                    sum = sum + 1;
                else if (hits[i] == 6 && (hits[i + 1] == 9 || hits[i + 1] == 4))
                    sum = sum + 2;
                else if (hits[i] == 6 && hits[i + 1] == 2)
                    sum = sum + 1.41421;
                else if (hits[i] == 6 && hits[i + 1] == 7)
                    sum = sum + 2 * 1.41421;
                //7
                    ...
                    sum = sum + 1.41421;
                else if (hits[i] == 7 && hits[i + 1] == 6)
                    sum = sum + 2*1.41421;
                else if (hits[i] == 7 && (hits[i + 1] == 9 || hits[i + 1] == 4))
                    sum = sum + 2;
                //8
                    ...
                    sum = sum + 1.41421;
                else if (hits[i] == 8 && hits[i + 1] == 5)
                    sum = sum + 2;
                //9
                else if (hits[i] == 9 && (hits[i + 1] == 1 || hits[i + 1] == 8))
                    sum = sum + 1;
                else if (hits[i] == 9 && (hits[i + 1] == 6 || hits[i + 1] == 7))
                    sum = sum + 2;
                else if (hits[i] == 9  && hits[i + 1] == 2)
                    sum = sum + 1.41421;
                else if (hits[i] == 9  && hits[i + 1] == 4)
                    sum = sum + 2*1.41421;
            }
